...
public OnPluginStart()
{
    ...
    hDmgSmash = CreateConVar("charger_dmg_impact",         			"0",    "Damage for impact after a charge.", FCVAR_PLUGIN, true, 0.0);
    hDmgStumble = CreateConVar("charger_dmg_stumble",      			"0",    "Damage for stumbled impact after a charge.", FCVAR_PLUGIN, true, 0.0);
    hDmgPound = CreateConVar("charger_dmg_pound",          			"24",    "Damage for pounds after charge/collision completed.", FCVAR_PLUGIN, true, 0.0);
    hDmgCappedVictim = CreateConVar("charger_dmg_cappedvictim",  	"8",    "Damage for capped Survivor victims.", FCVAR_PLUGIN, true, 0.0);
    hDmgIncappedPound = CreateConVar("charger_dmg_incapped",  	"24",    "Damage for incapped victims.", FCVAR_PLUGIN, true, 0.0);
